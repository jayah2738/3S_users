...
const GradeLessonsPage = ({ params }: PageProps) => {
      ...
      <div className="container mx-auto px-4 py-8 pt-24">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-bold text-gray-800 dark:text-white mb-4">
            Grade {params.grade} Lessons
          </h1>
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Access comprehensive lessons designed to enhance your understanding and knowledge
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {subjectlistdata.map((item, index) => (
            ...
            >
              <SubjectList
                key={index}
                programslists={`/lessons/${params.grade}/${item.id}`}
